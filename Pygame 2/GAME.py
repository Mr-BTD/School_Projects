...
bullet_img = pygame.transform.scale(pygame.image.load(
    os.path.join("Assets", "Bullets", "light_bullet.png")), (10, 10))
# Background
background = pygame.transform.scale(pygame.image.load(
    os.path.join("Assets", "Background.png")), (win_width, win_height))

# Tower
tower = pygame.transform.scale(pygame.image.load(
    os.path.join("Assets", "Tower.png")), (200, 200))

# Music/sound

music = pygame.mixer.Sound(os.path.join("Assets", "Auido", "music.ogg"))
pop_sound = pygame.mixer.Sound(os.path.join("Assets", "Auido", "pop.ogg"))
...
def draw_game():
    ...
    if player.alive == False:
        ...
        text = font.render("You Died! Press R to restart",
                           True, (255, 255, 255))
        ...
        if userInput[pygame.K_r]:
            ...
            speed = 2
    font = pygame.font.Font("freesansbold.ttf", 32)
    text = font.render("Lives: " + str(player.lives) + " | Tower health: " +
                       str(tower_health) + " | Kills: " + str(kills), True, (0, 0, 0))
